...
(defun color-theme-charcoal-black ()
  ...
  (color-theme-install
   '(color-theme-charcoal-black
     ...
     (custom-comment-face ((t (:background "#888A85")))) ;dim gray
     ...
     (font-lock-comment-face ((t (:foreground "#888A85")))) ;d: light blue
...
;     (mode-line ((t (:foreground "#eeeeec" :background "#555853")))) ;555753
     (mode-line ((t (:foreground "#340034" :background "#c9c9c9" :bold t)))) ;555753
