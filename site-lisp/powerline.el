...
;grey28
(defface powerline-active1 '((t (:background "SteelBlue4" :foreground "white" :bold t :inherit mode-line)))
  "Powerline face 1."
  :group 'powerline)

(defface powerline-active2 '((t (:background "grey32" :inherit mode-line)))
  "Powerline face 2."
  :group 'powerline)

(defface powerline-inactive1
  '((t (:background "grey18" :inherit mode-line-inactive)))
  "Powerline face 1."
  :group 'powerline)
